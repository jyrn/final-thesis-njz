          ...
          <div className={styles.inputGroup}>
            ...
            <div className={styles.uploadContainer}>
              ...
              <label htmlFor="resumeUpload" className={styles.uploadButton}>
                ...
                <span className={styles.uploadText}>{resumeFile ? resumeFile.name : "Click to upload resume"}</span>
                <span className={styles.uploadHint}>PDF, DOC, DOCX only</span>
              </label>
            </div>
          </div>

          <button type="submit" className={styles.registerButton} disabled={isUploading}>
            {isUploading ? "UPLOADING..." : "SIGN UP"}
          </button>
        </form>

        {/* Google Sign Up */}
        <button onClick={handleGoogleSignUp} className={styles.googleButton} disabled={isUploading}>
